...
const DashboardPage = async ({ searchParams }: DashboardPageProps) => {
    ...
    const [[totalRevenue], [totalAppointments], [totalPatients], [totalDoctors], doctorsList] = await Promise.all([
        db.select({
        ...
        db.select({
            ...
            .orderBy(desc(count(appointmentsTable.id))).limit(10)
    ]);
